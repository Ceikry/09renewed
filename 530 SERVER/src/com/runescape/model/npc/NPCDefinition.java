...
public class NPCDefinition {
	...
	private int respawn = 20, combat = 0, hitpoints = 1, maxHit = 0, size = 1, attackSpeed = 8, attackAnim = 422, defenceAnim = 404, deathAnim = 7197, attackBonus = 0, defenceMelee = 0, defenceRange = 0, defenceMage = 0;
	private boolean aggressive = false, superAggressive = false, bossMonster = false, attackable = true, retreats = false, poisonous = false;
