...
public class Bank {
	...
	private static final int MAX_SLOTS = 496;
	...
	public void determineBankerFaceDir(final Player p, final NPC n) {
		/*if (n.getFaceDirection() == 1) {
		
		} else if (n.getFaceDirection() == 1) {
	...
	public void openNpcBank(final Player p, final NPC n) {
		p.setEntityFocus(n.getClientIndex());
		
		if (n.getFaceDirection() == 1) { //North
			World.getInstance().registerCoordinateEvent(new AreaEvent(p, n.getLocation().getX() - 1, n.getLocation().getY() - 0, n.getLocation().getX() + 1, n.getLocation().getY() + 2) {
		...
		} else if (n.getFaceDirection() == 3) { //West
			World.getInstance().registerCoordinateEvent(new AreaEvent(p, n.getLocation().getX() - 2, n.getLocation().getY() - 1, n.getLocation().getX() + 0, n.getLocation().getY() + 1) {
		...
		} else if (n.getFaceDirection() == 4) { //East
			World.getInstance().registerCoordinateEvent(new AreaEvent(p, n.getLocation().getX() - 0, n.getLocation().getY() - 1, n.getLocation().getX() + 2, n.getLocation().getY() + 1) {
		...
		} else if (n.getFaceDirection() == 6) { //South
			World.getInstance().registerCoordinateEvent(new AreaEvent(p, n.getLocation().getX() - 1, n.getLocation().getY() - 2, n.getLocation().getX() + 1, n.getLocation().getY() + 0) {
