...
public class DoubleDoors {
    ...
    public void changeLeftDoor(DoubleDoors d) {
        ...
        if (xAdjustment != 0 || yAdjustment != 0) { 
        	//World.getInstance().getGlobalObjects().add
        	World.getInstance().getGlobalObjects().add(new WorldObject(-1, Location.location(d.x, d.y, d.z), 0, 0, false));
        ...
        World.getInstance().getGlobalObjects().add(new WorldObject(-1, Location.location(d.x, d.y, d.z), getNextLeftFace(d), 0, false));
    ...
    public void changeRightDoor(DoubleDoors d) {
        ...
        World.getInstance().getGlobalObjects().add(new WorldObject(-1, Location.location(d.x, d.y, d.z), getNextRightFace(d), 0, false));
    ...
    public void load() {
        ...
        logger.debug("Loaded "+ doors.size() +" Double doors in "+ (System.currentTimeMillis() - start) +"ms.");
    }
