...
public class Misc {
    ...
    public static int getRealDirection(int dir) {
        switch (dir) {
            case 0: return 45;
            case 1: return 0;
            case 2: return 315;
    ...
    /**
     * Calculate an X coordinate that a distance and direction make.
     */
    public static int lengthdirX(int length, int dir) {
        return (int) Math.round(length*Math.cos(dir));
    }

    /**
     * Calculate a Y coordinate that a distance and direction make.
     */
    public static int lengthdirY(int length, int dir) {
        return (int) Math.round(length*Math.sin(dir))*-1;
    }
