...
public class ItemData {
	...
	private static final String[] CAPES = {"cape","Cape","cloak"};
	...
	private static final int[] SHIELDID = {6524};
	private static final int[] TWO_HANDEDID = {6528};
	private static final int[] BODYID = {540,581,544,6107,1037};
	private static final int[] HATSID = {};
	private static final int[] LEGID = {538,542,6108,1033};
	private static final int[] WEAPONID = {6528,6527,6523,6525,6526,6522};
	...
	public static boolean isTwoHanded(int itemID) {
		...
		for(int i = 0; i < TWO_HANDEDID.length; i++) {
			if(itemID == TWO_HANDEDID[i]) {
				return true;
			}
		}
		return false;
	...
	private static final String[] TWO_HANDED = {"shortbow", "longbow", "godsword", "greataxe", "flail", "halberd", "hammer", "spear", "hammers", "2h sword", 
		"Saradomin sword", "Granite maul", "claws", "Karil's crossbow", "Tzhaar-ket-om", "Crystal bow", "Dark bow", "Shortbow", "Longbow"};
