...
public class Animations {
	...
	public static int getAttackAnimation(Player p) {
		...
		if (weapon.contains("Tzhaar-ket-em")) {
			return 401;
		}
		...
		if (weapon.contains("Toktz-mej-tal") || weapon.contains("pickaxe") || weapon.contains("mace") || weapon.contains("warhammer") || weapon.contains("staff") || weapon.contains("Staff") || weapon.contains("wand") || weapon.contains(" axe")) {
			return 393;
		}
		...
		if (weapon.contains(" dagger") || weapon.contains("Totkz-xil-ak")) {
			return 412;
		}
		...
		if (weapon.contains("Dragon longsword") || weapon.contains("scimitar") || weapon.contains("Toktz-xil-ek")) {
			return 451;
		}
		if (weapon.contains("Shortbow") || weapon.contains("Longbow")) {
			return 426;
		}
		if (weapon.contains("shortbow") || weapon.contains("longbow")) {
			return 426;
